...
func TestParseTaintsFromLabels(t *testing.T) {
	tests := []struct {
		name       string
		...
		},
		{
			...
			nodeLabels: map[string]string{
				"crusoe.ai/taint.gpu-workload": "NoSchedule",
			},
			expected: []v1.Taint{
				{
					Key:    "crusoe.ai/gpu-workload",
					Value:  "",
		...
		},
		{
			...
			nodeLabels: map[string]string{
				"crusoe.ai/taint.dedicated": "PreferNoSchedule",
			},
			expected: []v1.Taint{
				{
					Key:    "crusoe.ai/dedicated",
					Value:  "",
		...
		},
		{
			...
			nodeLabels: map[string]string{
				"crusoe.ai/taint.maintenance": "NoExecute",
			},
			expected: []v1.Taint{
				{
					Key:    "crusoe.ai/maintenance",
					Value:  "",
		...
		},
		{
			...
			nodeLabels: map[string]string{
				"crusoe.ai/taint.gpu-workload": "true:NoSchedule",
			},
			expected: []v1.Taint{
				{
					Key:    "crusoe.ai/gpu-workload",
		...
		},
		{
			...
			nodeLabels: map[string]string{
				"crusoe.ai/taint.gpu-workload": "NoSchedule",
				"crusoe.ai/taint.dedicated":    "team-a:PreferNoSchedule",
		...
		},
		{
			...
			nodeLabels: map[string]string{
				"crusoe.ai/taint.invalid": "InvalidEffect",
			},
			expected: nil,
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := parseTaintsFromLabels(tt.nodeLabels)
...
func TestGetManagedTaints(t *testing.T) {
	tests := []struct {
		name     string
		taints   []v1.Taint
		expected []v1.Taint
		...
		},
		{
			...
			taints: []v1.Taint{
				{Key: "crusoe.ai/gpu-workload", Effect: v1.TaintEffectNoSchedule},
				{Key: "crusoe.ai/dedicated", Value: "team-a", Effect: v1.TaintEffectPreferNoSchedule},
			},
			expected: []v1.Taint{
				{Key: "crusoe.ai/gpu-workload", Effect: v1.TaintEffectNoSchedule},
				{Key: "crusoe.ai/dedicated", Value: "team-a", Effect: v1.TaintEffectPreferNoSchedule},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := getManagedTaints(tt.taints)
			assert.Equal(t, tt.expected, result)
		})
	}
}
...
func TestDiffTaints(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			desired: []v1.Taint{
				{Key: "crusoe.ai/gpu-workload", Effect: v1.TaintEffectNoExecute},
			},
			expectedAdd: []v1.Taint{
				{Key: "crusoe.ai/gpu-workload", Effect: v1.TaintEffectNoExecute},
			},
		...
		},
		{
			...
			current: []v1.Taint{
				{Key: "crusoe.ai/dedicated", Value: "team-a", Effect: v1.TaintEffectNoSchedule},
			},
			desired: []v1.Taint{
				{Key: "crusoe.ai/dedicated", Value: "team-b", Effect: v1.TaintEffectNoSchedule},
			},
			expectedAdd: []v1.Taint{
				{Key: "crusoe.ai/dedicated", Value: "team-b", Effect: v1.TaintEffectNoSchedule},
			},
		...
		},
		{
			name: "complex diff",
			current: []v1.Taint{
				{Key: "crusoe.ai/to-keep", Effect: v1.TaintEffectNoSchedule},
				{Key: "crusoe.ai/to-remove", Effect: v1.TaintEffectNoSchedule},
				{Key: "crusoe.ai/to-update", Value: "old", Effect: v1.TaintEffectNoSchedule},
			},
			desired: []v1.Taint{
				{Key: "crusoe.ai/to-keep", Effect: v1.TaintEffectNoSchedule},
				{Key: "crusoe.ai/to-add", Effect: v1.TaintEffectNoExecute},
				{Key: "crusoe.ai/to-update", Value: "new", Effect: v1.TaintEffectNoSchedule},
			},
			expectedAdd: []v1.Taint{
				{Key: "crusoe.ai/to-add", Effect: v1.TaintEffectNoExecute},
				{Key: "crusoe.ai/to-update", Value: "new", Effect: v1.TaintEffectNoSchedule},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			toAdd, toRemove := diffTaints(tt.current, tt.desired)
