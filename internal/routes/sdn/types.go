...
// controller depends on no grpc/protobuf types. Only a single file
// (sdn/grpc.go) maps between these structs and the pb types.
package sdn
...
// operation_ids, though CreateRoute polls one operation at a time.
